...
def parse_args(args=None):
    ...
    parser.add_argument('--tasks', default='1p.2p.3p.4p.2i.3i.4i.ip.pi.2in.3in.inp.pin.pni.2u.up', type=str, help="tasks connected by dot, refer to the BetaE paper for detailed meaning and structure of each task")
...
def main(args):
    ...
    if os.path.basename(os.getcwd()) != 'KGReasoning':
        prefix = os.path.join('KGReasoning', prefix)
