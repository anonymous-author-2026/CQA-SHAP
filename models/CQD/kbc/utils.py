    ...
    try:
        ...
        if QuerDAG.TYPE1_1.value == graph_type:
            ...
            for chain_iter in range(len(part4)):
                ...
                flattened_part3.append([part3[chain_iter][0], part3[chain_iter][1], part3[chain_iter][2]])
                flattened_part2.append([part2[chain_iter][0], part2[chain_iter][1], part2[chain_iter][2]])
                flattened_part1.append([part1[chain_iter][0], part1[chain_iter][1], part1[chain_iter][2]])
        ...
        elif QuerDAG.TYPE2_4.value == graph_type:
            raw = dataset.type2_4chain

            type2_4chain = []
            for i in range(len(raw)):
                type2_4chain.append(raw[i].data)

            part1 = [x['raw_chain'][0] for x in type2_4chain]
            part2 = [x['raw_chain'][1] for x in type2_4chain]
            part3 = [x['raw_chain'][2] for x in type2_4chain]
            part4 = [x['raw_chain'][3] for x in type2_4chain]
